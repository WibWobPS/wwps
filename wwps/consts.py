OG_GAMESERVER_URL = "https:\\/\\/gameserver.yw-p.com"
DEFAULT_OBTAINED_ICONS_AND_TITLES = "1*2"
...
def msg_box_response(dialog_msg: str, dialog_title: str) -> dict:
    return {
        "dialogMsg": dialog_msg,
        "gameServerUrl": OG_GAMESERVER_URL,
        "resultCode": 0,
        "storeUrl": "",
